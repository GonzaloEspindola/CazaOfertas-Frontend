...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
    <rect :fill="props.primaryColor" width="2000" height="1500" />
    <defs>
      <radialGradient id="a" gradientUnits="objectBoundingBox">
        <stop offset="0" :stop-color="props.lightColor" />
        <stop offset="1" :stop-color="props.primaryColor" />
      </radialGradient>
      <linearGradient
        id="b"
        ...
        y2="750"
      >
        <stop offset="0" :stop-color="props.secondaryColor" />
        <stop offset="1" :stop-color="props.primaryColor" />
      </linearGradient>
      <path
        id="s"
    ...
    <g transform="translate(300 0)">
      <g transform="translate(0 105)">
        ...
        <circle fill-opacity="0.39" fill="url(#a)" r="3000" />
      </g>
    </g>
  </svg>
</template>
